...
# ==================================================================================================
# Codex CLI OAuth Provider Settings
# ==================================================================================================

# Path to Codex CLI auth file (created automatically by `codex` CLI after login)
CODEX_AUTH_FILE: str = os.getenv("CODEX_AUTH_FILE", "~/.codex/auth.json")
# Set to false to disable the Codex provider even if the auth file exists
